...
lines = [
    ...
    ("Scientist", "He's awake!"),
    ("Player", "Whaa! Who are you?"),
    ("Scientist", "Whoa! Easy there bud! Don't fall off -  your legs are still adjusting. My name is "),
    ("???", "Well, now that you know us, "),
