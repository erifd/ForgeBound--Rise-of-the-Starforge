...
import time
import os
import Platformer.Game.event_manager as em
...
def run_storyline():
    ...
    # your game loop here
    # when it's done, return control
    return "done"

def on_player_movement(direction):
    print(f"Storyline received: player moved {direction}")
...
lines = [
    ("Player", "Where am I?"),
    ("Ron", "You have been deployed on the planet; Solarite."),
    ("Player", "So, are you the reclusive guy who likes running the ship and didn't want to see me?"),
    ("Ron", "Is that what Edison said now? Well, yeah, it's true. Just didn't want to disturb you."),
    ("Player", "So, it seems that there is some history between you guys?"),
    ("Ron", "'Some' history would be an underestimate."),
    ("Edison", "RON! Have you seriously been discussing our history with Kael?"),   #TODO - Get the player name stuff sorted out - kael is the beginner guy
    ("Ron", "Ahh, there you are! I was wondering where you were. You said you would patch in to help!"),
    ("Player", "**cough cough** Aheemm, I am still confused about where I am."),
    ("Edison", "Sorry Kael."),
    ("Ron", "Yeah, sorry Kael. Let's get back to this."),
    ("System", "Ron will remember that.")
    ("Ron", "OK, so ")
]
# Tutorial Vars
